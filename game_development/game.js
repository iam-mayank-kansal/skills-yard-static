...
show_lang_btns[11].setAttribute("style", "transform:scale(1.3) ; opacity:1 ; filter:grayscale(0)");
        show_lang_btns[7].setAttribute("style", "transform:scale(1.3) ; opacity:1 ; filter:grayscale(0) ; display:none");
...
let gameBox = document.querySelectorAll(".student-game");


let showMoreGames = document.querySelectorAll(".show-more-games");
...
showMoreGames[0].addEventListener("click",()=>{
    if(flag3D == 0){
        gameBox[2].style.display = "flex";
        gameBox[3].style.display = "flex";
        showMoreGames[0].innerText = "Show Less";
        flag3D = 1;
    }
    else{
        gameBox[2].style.display = "none";
        gameBox[3].style.display = "none";
        showMoreGames[0].innerText = "Show More";
        flag3D = 0;
    }
})
showMoreGames[1].addEventListener("click",()=>{
    if(flag2D == 0){
        gameBox[6].style.display = "flex";
        gameBox[7].style.display = "flex";
        showMoreGames[1].innerText = "Show Less";
        flag2D = 1;
    }
    else{
        gameBox[6].style.display = "none";
        gameBox[7].style.display = "none";
        showMoreGames[1].innerText = "Show More";
        flag2D = 0;
    }
})
