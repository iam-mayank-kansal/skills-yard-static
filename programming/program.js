...
// our courses lang sec 


const langBoxes = document.querySelectorAll(".all-courses-boxes-all");
const langCon = document.querySelector(".all-courses-inner-container");
let scrolled = 0;
setInterval(() => {
    langCon.scrollLeft += 260;
    scrolled += 260;
    if (scrolled === 1040) {
        langCon.scrollLeft = 0;
        scrolled = 0;
    }
    if (scrolled === 780) {
        langCon.style.scrollBehavior = "auto";
    }
    else {
        langCon.style.scrollBehavior = "smooth";
    }
}, 3000);
